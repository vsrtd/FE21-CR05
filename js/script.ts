class locations {
    constructor(public place: string, public zipCode: number, public address: string, public image:string, public date: any){
    }
...
class restaurants extends locations {
    constructor(public place: string, public zipCode: number, public address: string, public image:string, public date: any, public telephone: string, public cuisine: string, public url: string){
...
class events extends locations {
    constructor(public place: string, public zipCode: number, public address: string, public image:string, public date: any, public eventDate: string, public eventTime: string, public ticketPrice: number){
        super(place,zipCode,address,image,date);
    }
